...
import Chat from "../components/reports/chat_a.jsx";

export default function Report_A() {
            ...
            <div
              ...
              <div
                ...
                <section className="w-full max-w-xs sm:max-w-sm md:max-w-lg mx-auto flex flex-col gap-3">
                  <button
                    className="w-full py-2  bg-gradient-to-r from-teal-600 to-sky-600 rounded-md text-white inline-flex items-center justify-center gap-2"
                    onClick={handleChat}>
